 ...
 */
public class KingActivity extends FragmentActivity {
    ...
    private KingAdapter mKingAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int previousScore = mSharedPreferences.getInt(PREF_KING_SCORE, 0);
        Toast.makeText(this, "Your highest score is, " + previousScore + "!", Toast.LENGTH_SHORT).show();
        ...
        mKingAdapter = new KingAdapter(getApplicationContext(), R.layout.king_row, myKingsArray);

        if (mListView != null) {
            mListView.setAdapter(mKingAdapter);
        }
    ...
    public void setCorrectStatus(King king) {
        ...
        answerView.setText("Correct! " + king.getName());
    ...
    public void storeHighScore() {
        mSharedPreferences = getSharedPreferences("prefs", MODE_PRIVATE);
        int storedValue = mSharedPreferences.getInt(PREF_KING_SCORE, 0);
        ...
        e.putInt(PREF_KING_SCORE, highScore);
        e.commit();
    }
    ...
    public void askQuestion() {
        ...
        if (kingInQuestion.isAnswered()) {
            ...
            questionView.setText("Who is " + kingInQuestion.getName() + "? (" + (kingInQuestion.getAnswer().getNumberOfGuesses() + 1) + "/3)");
